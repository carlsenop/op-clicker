...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$3, 26, 4, 495);
    			add_location(div, file$3, 25, 0, 485);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	let div1;
    	let div0;
    	let if_block = /*$BossDeath*/ ctx[0] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 43, 4, 913);
    			attr_dev(div1, "class", "progress-container");
    			add_location(div1, file$2, 42, 0, 875);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, Experience, $$value => $$invalidate(5, $Experience = $$value));
    	validate_store(Level, "Level");
    	component_subscribe($$self, Level, $$value => $$invalidate(7, $Level = $$value));
    	validate_store(ClickDmg, "ClickDmg");
    	component_subscribe($$self, ClickDmg, $$value => $$invalidate(8, $ClickDmg = $$value));
    	validate_store(BossDeath, "BossDeath");
    	component_subscribe($$self, BossDeath, $$value => $$invalidate(0, $BossDeath = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	function CalcReqXp() {
    		$$invalidate(4, RequiredXp = RequiredXp ** 1.1);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ("RequiredXp" in $$props) $$invalidate(4, RequiredXp = $$props.RequiredXp);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*RequiredXp, $Experience*/ 48) {
    			XpLeft = RequiredXp - $Experience;
    		}
    	};

    	return [$BossDeath, $Progress, Progress, please, RequiredXp, $Experience];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 15, 3, 431);
    			attr_dev(div1, "class", "fattext bosstext");
    			add_location(div1, file, 16, 3, 480);
    			add_location(div2, file, 18, 3, 564);
    			attr_dev(section0, "class", "grid");
    			add_location(section0, file, 14, 2, 405);
    			attr_dev(div3, "class", "fattext green");
    			add_location(div3, file, 22, 3, 660);
    			add_location(br, file, 23, 55, 764);
    			attr_dev(div4, "class", "lesstext green");
    			add_location(div4, file, 23, 3, 712);
    			attr_dev(section1, "class", "bottomgrid");
    			add_location(section1, file, 21, 2, 628);
    			add_location(div5, file, 25, 3, 813);
    			add_location(div6, file, 20, 19, 620);
    			add_location(div7, file, 20, 3, 604);
    			attr_dev(main, "class", "backy");
    			add_location(main, file, 13, 1, 380);
    			add_location(body, file, 12, 1, 371);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
